...
function DashboardMotoclubs() {
  ...
  const { data, isLoading } = useGetDashboardMotoclubListQuery({ pagination })
      ...
      render: (_value, record) => (
        <Space>
          ...
          <Popconfirm
            ...
            onConfirm={() => handleDeleteMotoclub(record.id)}
          >
  ...
  return (
    <Card size="small">
      <Space style={{ width: '100%', justifyContent: 'space-between', marginBottom: 16 }}>
        ...
        <Link to="/dashboard/motoclubs/create">
...
export default DashboardMotoclubs
