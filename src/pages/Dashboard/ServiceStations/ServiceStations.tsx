...
function DashboardServiceStations() {
  ...
  const { data, isLoading } = useGetDashboardServiceStationListQuery({ pagination })
  ...
  const columns: ColumnsType<ServiceStation> = [
    ...
    },
    {
      ...
      render: (_value, record) => (
        <Space>
          <Link to={`/dashboard/service-stations/${record.id}/edit`}>
          ...
          <Popconfirm
            ...
            onConfirm={() => handleDeleteServiceStation(record.id)}
          >
  ...
  return (
    <Card size="small">
      <Space style={{ width: '100%', justifyContent: 'space-between', marginBottom: 16 }}>
        ...
        <Link to="/dashboard/service-stations/create">
...
export default DashboardServiceStations
